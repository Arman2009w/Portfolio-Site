tailwind.config = {
    ...
    // The prefix ensures Tailwind classes don't conflict with custom CSS classes if any
    prefix: '', 
    // Important is set to 'false' to allow custom CSS to override utility classes gracefully
    important: false, 
};
